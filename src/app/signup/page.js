                ...
                <div class="w-full max-w-lg">
                    <form class="bg-transparent border border-gray-500 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                class="bg-transparent shadow appearance-none border hidden:border-red-500 rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
                                id="password"
                                type="password"
                                placeholder="********"
                            />
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                class="bg-transparent shadow appearance-none border hidden:border-red-500 rounded w-full py-2 px-3 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                                id="cpassword"
                                type="password"
                                placeholder="********"
                            />
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a
                                class="inline-block align-baseline font-bold text-sm hover:scale-105 hover:text-gray-500 duration-200 link-underline"
                                href="#"
                            >
