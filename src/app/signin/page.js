                    ...
                    <form class="bg-transparent border border-gray-500 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                ...
                                placeholder="********"
                            />
                            <p class={false ? 'text-red-500 text-xs italic' : 'hidden text-red-500 text-xs italic'}>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                <a
                                    class="m-2 block align-baseline font-bold text-sm hover:scale-105 hover:text-gray-500 duration-200 link-underline"
                                    href="#"
                                >
                                    Forgot Password?
                                </a>
